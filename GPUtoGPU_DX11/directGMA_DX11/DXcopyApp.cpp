...
HRESULT DXcopyApp::Init(HINSTANCE hInstance, int nCmdShow)
{
	...
	unsigned int gpu0_uiDsp = ADLagent::getDisplayOnGPU(0, 0); 
	ADLagent::DisplayData* gpu0_pDsp = ADLagent::getDisplayData(gpu0_uiDsp);

	unsigned int gpu1_uiDsp = ADLagent::getDisplayOnGPU(1, 0); 
	ADLagent::DisplayData* gpu1_pDsp = ADLagent::getDisplayData(gpu1_uiDsp);
